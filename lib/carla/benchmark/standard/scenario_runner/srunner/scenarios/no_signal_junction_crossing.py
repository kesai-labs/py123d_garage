...
class NoSignalJunctionCrossing(BasicScenario):
    ...
    def __init__(
        ...
        super(NoSignalJunctionCrossing, self).__init__(
            "NoSignalJunctionCrossing", ego_vehicles, config, world, debug_mode, criteria_enable=criteria_enable,
        )
...
class NoSignalJunctionCrossingRoute(BasicScenario):
    ...
    def __init__(
        ...
        super(NoSignalJunctionCrossingRoute, self).__init__(
            "NoSignalJunctionCrossingRoute", ego_vehicles, config, world, debug_mode, criteria_enable=criteria_enable,
        )
