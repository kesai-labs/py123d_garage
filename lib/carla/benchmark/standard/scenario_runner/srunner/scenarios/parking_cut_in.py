...
from srunner.tools.background_manager import ChangeRoadBehavior, LeaveSpaceInFront
...
class ParkingCutIn(BasicScenario):
    ...
    def __init__(
        ...
        super().__init__("ParkingCutIn", ego_vehicles, config, world, debug_mode, criteria_enable=criteria_enable)
