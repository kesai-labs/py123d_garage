...
from srunner.tools.background_manager import ChangeOppositeBehavior, ReAddRoadLane, RemoveRoadLane, SetMaxSpeed
...
class ConstructionObstacle(BasicScenario):
    ...
    def _create_construction_setup(self, start_transform, lane_width):
        ...
        _prop_names = {"warning_sign": "static.prop.trafficwarning", "debris": "static.prop.dirtdebris02"}
        ...
        for key, value in _initial_offset.items():
            ...
            spawn_transform.location.z -= 200
            static = CarlaDataProvider.request_new_actor(_prop_names[key], spawn_transform)
