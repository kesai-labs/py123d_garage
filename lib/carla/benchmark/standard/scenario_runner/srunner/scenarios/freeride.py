...
class FreeRide(BasicScenario):
    ...
    def __init__(
        self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True, timeout=10000000,
    ):
        """
        ...
        super(FreeRide, self).__init__(
            "FreeRide", ego_vehicles, config, world, debug_mode, criteria_enable=criteria_enable,
        )
