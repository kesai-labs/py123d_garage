...
class ManeuverOppositeDirection(BasicScenario):
    ...
    def __init__(
        ...
        super(ManeuverOppositeDirection, self).__init__(
            "ManeuverOppositeDirection", ego_vehicles, config, world, debug_mode, criteria_enable=criteria_enable,
        )
    ...
    def _initialize_actors(self, config):
        ...
        first_actor_transform = carla.Transform(
            first_actor_waypoint.transform.location, first_actor_waypoint.transform.rotation,
        )
