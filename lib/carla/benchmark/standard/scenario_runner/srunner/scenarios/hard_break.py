...
from srunner.tools.background_manager import StartFrontVehicles, StopFrontVehicles
...
class HardBreakRoute(BasicScenario):
    ...
    def __init__(
        ...
        super().__init__("HardBreak", ego_vehicles, config, world, debug_mode, criteria_enable=criteria_enable)
