...
from srunner.scenariomanager.scenarioatomics.atomic_behaviors import BicycleFlow, ScenarioTimeout, TrafficLightFreezer
...
class CrossingBicycleFlow(BasicScenario):
    ...
    def __init__(
        ...
        super().__init__(
            "CrossingBicycleFlow", ego_vehicles, config, world, debug_mode, criteria_enable=criteria_enable,
        )
