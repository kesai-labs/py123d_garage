...
from srunner.tools.background_manager import ChangeOppositeBehavior, ReAddRoadLane, RemoveRoadLane
...
class InvadingTurn(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, debug_mode=False, criteria_enable=True, timeout=180):
        ...
        super().__init__("InvadingTurn", ego_vehicles, config, world, debug_mode, criteria_enable=criteria_enable)
