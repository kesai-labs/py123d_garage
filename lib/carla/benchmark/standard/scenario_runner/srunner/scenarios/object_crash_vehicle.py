...
from srunner.tools.background_manager import LeaveCrossingSpace, LeaveSpaceInFront
...
class StationaryObjectCrossing(BasicScenario):
    ...
    def __init__(
        ...
        super(StationaryObjectCrossing, self).__init__(
            "Stationaryobjectcrossing", ego_vehicles, config, world, debug_mode, criteria_enable=criteria_enable,
        )
    ...
    def _create_behavior(self):
        ...
        # non leaf nodes
        root = py_trees.composites.Parallel(name="StaticObstacle", policy=py_trees.common.ParallelPolicy.SUCCESS_ON_ONE)
...
class DynamicObjectCrossing(BasicScenario):
    ...
    def __init__(
        ...
        super(DynamicObjectCrossing, self).__init__(
            "DynamicObjectCrossing", ego_vehicles, config, world, debug_mode, criteria_enable=criteria_enable,
        )
    ...
    def _create_behavior(self):
        ...
        trigger_adversary.add_child(
            InTimeToArrivalToLocation(self.ego_vehicles[0], self._reaction_time, collision_location),
        )
        trigger_adversary.add_child(
            InTriggerDistanceToLocation(self.ego_vehicles[0], collision_location, self._min_trigger_dist),
        )
...
class ParkingCrossingPedestrian(BasicScenario):
    ...
    def __init__(
        ...
        super().__init__(
            "ParkingCrossingPedestrian", ego_vehicles, config, world, debug_mode, criteria_enable=criteria_enable,
        )
