...
from srunner.tools.background_manager import ChangeRoadBehavior, LeaveSpaceInFront, ReAddRoadLane, RemoveRoadLane
...
class StaticCutIn(BasicScenario):
    ...
    def __init__(
        ...
        super().__init__("StaticCutIn", ego_vehicles, config, world, debug_mode, criteria_enable=criteria_enable)
    ...
    def _create_behavior(self):
        ...
        cut_in_movement.add_child(
            CutIn(self._adversary_actor, self.ego_vehicles[0], cut_in_direction, change_time=3, other_lane_time=2),
        )
        cut_in_movement.add_child(BasicAgentBehavior(self._adversary_actor, plan=self._plan, target_speed=self._speed))
