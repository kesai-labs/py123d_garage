...
from srunner.tools.background_manager import ChangeJunctionBehavior, ChangeOppositeBehavior, ChangeRoadBehavior
...
class BackgroundActivityParametrizer(BasicScenario):
    ...
    def __init__(
        ...
        super().__init__(
            "BackgroundActivityParametrizer", ego_vehicles, config, world, debug_mode, criteria_enable=criteria_enable,
        )
    ...
    def _create_behavior(self):
        ...
        sequence.add_child(
            ChangeOppositeBehavior(self._opposite_source_dist, self._opposite_spawn_dist, self._opposite_active),
        )
