...
python -m py123d_garage.cache.build_cache \
	training@plan=py123d_garage.config.presets.python.training.transfuser:tf_carla_train \
	hydra.run.dir="outputs/build_cache_carla/shard_${SLURM_ARRAY_TASK_ID:-0}" \
