...
python -m py123d_garage.cache.build_cache \
	training@plan=py123d_garage.config.presets.python.training.transfuser:tf_nuplan_trainval \
	hydra.run.dir="outputs/build_cache_nuplan/shard_${SLURM_ARRAY_TASK_ID:-0}" \
