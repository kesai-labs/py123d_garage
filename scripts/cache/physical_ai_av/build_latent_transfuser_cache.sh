...
python -m py123d_garage.cache.build_cache \
	training@plan=py123d_garage.config.presets.python.training.latent_transfuser:ltf_physical_ai_av_trainvaltest \
	hydra.run.dir="outputs/build_latent_cache_physical_ai_av/shard_${SLURM_ARRAY_TASK_ID:-0}" \
